...
public class AttributeDataNameArrayListAdapter extends ArrayAdapter<String> implements
        Filterable, ISpinnerSelectedView {
    ...
    public AttributeDataNameArrayListAdapter(Context context, ArrayList<String> strings) {
    ...
    public View getNoSelectionView() {
        return View.inflate(mContext, R.layout.view_list_attribute_data_name_selection_item, null);
    }
