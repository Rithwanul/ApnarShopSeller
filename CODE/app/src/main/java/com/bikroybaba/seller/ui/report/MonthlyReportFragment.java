...
import com.bikroybaba.seller.databinding.FragmentMonthlyBinding;
...
public class MonthlyReportFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil
                .inflate(inflater, R.layout.fragment_monthly, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.monthlySwipeRefresh.setOnRefreshListener(() -> {
            binding.monthlySwipeRefresh.setRefreshing(false);
            ReportRequest reportRequest1 =
                    new ReportRequest(utility.getCategoryId(), utility.getProductTypeId(),
                            utility.getProductId(), "MONTH", "", "");
