...
import com.bikroybaba.seller.databinding.FragmentWeeklyBinding;
...
public class WeeklyReportFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil
                .inflate(inflater, R.layout.fragment_weekly, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.weeklySwipeRefresh.setOnRefreshListener(() -> {
            binding.weeklySwipeRefresh.setRefreshing(false);
            ReportRequest reportRequest1 =
                    new ReportRequest(utility.getCategoryId(), utility.getProductTypeId(),
                            utility.getProductId(), "WEEK", "", "");
